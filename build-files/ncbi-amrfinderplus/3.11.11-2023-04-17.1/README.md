...
The database included at time of docker image build is **`2023-04-17.1`**. More information can be found in the changes.txt on [NCBI's FTP](https://ftp.ncbi.nlm.nih.gov/pathogen/Antimicrobial_resistance/AMRFinderPlus/database/3.11/2023-04-17.1/changes.txt).
...
# example
staphb/ncbi-amrfinderplus:3.11.11-2023-04-17.1
```
