...
The database included at time of docker image build is **`2026-05-15.1`**. More information can be found in the [changes.txt on NCBI's FTP](https://ftp.ncbi.nlm.nih.gov/pathogen/Antimicrobial_resistance/AMRFinderPlus/database/4.2/2026-05-15.1/changes.txt).
