...
The database included at time of docker image build is **`2023-07-13.2`**. More information can be found in the changes.txt on [NCBI's FTP](https://ftp.ncbi.nlm.nih.gov/pathogen/Antimicrobial_resistance/AMRFinderPlus/database/3.11/2023-07-13.2/changelog.txt).
...
Software version: 3.11.17
Database directory: '/amrfinder/data/2023-07-13.2'
Database version: 2023-07-13.2
