# plassembler container

Main tool: [plassembler](https://github.com/gbouras13/plassembler)
...
──────────────────────────────────────────────────────────────────────────────
  ...
  chopper                    0.9.1         hcdda2d0_0            bioconda   
  ...
  fastp                      0.24.0        heae3180_1            bioconda   
  flye                       2.9.5         py38hd638cd3_1        bioconda   
  ...
  openjdk                    23.0.2        h68779a4_0            conda-forge
  ...
  perl-pathtools             3.75          pl5321hb9d3cd8_1      conda-forge
  perl-scalar-list-utils     1.68          pl5321hb9d3cd8_0      conda-forge
  perl-storable              3.15          pl5321hb9d3cd8_0      conda-forge
  perl-types-serialiser      1.01          pl5321hdfd78af_0      bioconda   
  pip                        24.3.1        pyh8b19718_0          conda-forge
  pixman                     0.44.2        h29eaf8c_0            conda-forge
  plassembler                1.6.2         pyhdfd78af_0          bioconda   
  pthread-stubs              0.4           hb9d3cd8_1002         conda-forge
  pulseaudio-client          17.0          hb77b528_0            conda-forge
  pycparser                  2.22          pyhd8ed1ab_0          conda-forge
  pyrodigal                  3.6.3         py38h0020b31_0        bioconda   
...
The plsdb database that plassembler uses has been pre-downloaded at /plassembler_db using the following command:
```
