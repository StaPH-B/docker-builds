...
```bash
# simulation of 30X HiSeq paired-end reads of 150bp with the mean fragment size 500 and standard deviation 10 using the built-in a HiSeq quality profile
