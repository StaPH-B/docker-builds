...
| [Kraken2](https://hub.docker.com/r/staphb/kraken2/) <br/> [![docker pulls](https://img.shields.io/docker/pulls/staphb/kraken2.svg?style=popout)](https://hub.docker.com/r/staphb/kraken2) | 2.0.8-beta (no database),<br/> 2.0.8-beta (MiniKraken2_v1_8GB db),<br/> 2.0.8-beta_hv (human + virus db) | https://github.com/DerrickWood/kraken2 |
...
| [NanoPlot](https://hub.docker.com/r/staphb/nanoplot) <br/> [![docker pulls](https://img.shields.io/docker/pulls/staphb/nanoplot.svg?style=popout)](https://hub.docker.com/r/staphb/nanoplot) | 1.27.0, 1.29.0, 1.30.1, 1.32.0 | https://github.com/wdecoster/NanoPlot |
