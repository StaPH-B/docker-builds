...
| [Augur](https://github.com/nextstrain/augur) <br/> [![docker pulls](https://img.shields.io/docker/pulls/staphb/augur.svg?style=popout)](https://hub.docker.com/r/staphb/augur) | 6.3.0 | https://github.com/nextstrain/augur |
...
| [centroid](https://hub.docker.com/r/staphb/centroid/) <br/> [![docker pulls](https://img.shields.io/docker/pulls/staphb/centroid.svg?style=popout)](https://hub.docker.com/r/staphb/centroid) | 0.1 (no version) | https://github.com/https://github.com/stjacqrm/centroid |
...
| [iVar](https://hub.docker.com/r/staphb/ivar/) <br/> [![docker pulls](https://img.shields.io/docker/pulls/staphb/ivar.svg?style=popout)](https://hub.docker.com/r/staphb/ivar) | 1.1, 1.1 (+ SARS-CoV2 reference),<br/> 1.2.1, 1.2.1 (+ SARS-CoV2 ref) | https://github.com/andersen-lab/ivar |
...
| [NanoPlot](https://hub.docker.com/r/staphb/nanoplot) <br/> [![docker pulls](https://img.shields.io/docker/pulls/staphb/nanoplot.svg?style=popout)](https://hub.docker.com/r/staphb/nanoplot) | 1.27.0, 1.29.0 | https://github.com/wdecoster/NanoPlot |
...
| [SeqSero2](https://hub.docker.com/r/staphb/seqsero2/) <br/> [![docker pulls](https://img.shields.io/docker/pulls/staphb/seqsero2.svg?style=popout)](https://hub.docker.com/r/staphb/seqsero2) | 0.1.0, 1.0.0, 1.0.2, 1.1.0 | https://github.com/denglab/SeqSero2/ |
