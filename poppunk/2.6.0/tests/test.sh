...
sed 's/^prefix_//' output/output_clusters.csv | awk 'NR==1{print $0;next} {print $0| "sort"}' > assigned.csv
awk 'NR==1{print $0;next} {print $0| "sort"}' database/database_clusters.csv > database.csv
